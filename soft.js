        ...
        bt.send('get_plugin_remarks','auth/get_plugin_remarks',{},function(pro_info){
            ...
            if(type == 10){
                ...
                btn_ground = soft.render_tips_btn(btn_ground,[
                    {title:'免费入驻',href:'https://v7.hostcli.com/developer/',rel:'noreferrer noopener',target:'_blank',btn:'免费入驻',class:'btn btn-success btn-xs va0',style:"margin-left:10px;"},
                    {title:'点击获取第三方应用',rel:'noreferrer noopener',href:'https://v7.hostcli.com/bbs/forum-40-1.html',target:'_blank',btn:'获取第三方应用',class:'btn btn-success btn-xs va0 ml15',style:"margin-left:10px;"},
                ...
                btn_ground = soft.render_tips_btn(btn_ground,[
                    {title:'免费入驻',href:'https://v7.hostcli.com/bbs/thread-33063-1-1.html',rel:'noreferrer noopener',target:'_blank',btn:'免费入驻',class:'btn btn-success btn-xs va0',style:"margin-left:10px;"},
                ...
                var set_btn_style = function(res){
                    if(!res.status || !res){
                        ...
                        if(type == 12 && (ltd < 0 && pro >=0)){
                            explain.html('企业版可以免费使用专业版及企业版插件，了解专业版和企业版的区别，请点击<a href="https://v7.hostcli.com/download/linux.html" target="_blank" class="btlink ml5">查看详情</a>。<a href="https://v7.hostcli.com/bbs/forum.php?mod=viewthread&tid=50342&page=1&extra=#pid179211" target="_blank" class="btlink ml5">《专业版升级企业版教程》</a>');
